    ...
    <div className="rounded-xl border border-ink-600 bg-ink-800/50 p-4">
      ...
      <form onSubmit={add} className="mb-4 flex flex-wrap gap-2">
        ...
        <input
          ...
          placeholder="Add an investigation note to the diary…"
      ...
      {loading ? (
        ...
        <p className="text-xs text-slate-500">
          No diary entries yet. Adding parties, seizures, statements, or
          generating documents auto-logs entries here.
        </p>
      ) : (
